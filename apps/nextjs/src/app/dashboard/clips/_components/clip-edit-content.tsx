...
export function ClipEditContent(props: {
  ...
  useEffect(() => {
    ...
    setForm({
      ...
      scheduledAt: clip.scheduledAt ? toDatetimeLocalValue(new Date(clip.scheduledAt)) : "",
    });
    setDidInit(true);
  }, [clip, didInit]);

  const title = useMemo(() => {
    if (clipQuery.isLoading) return "Edit clip";
  ...
  }, [clip, form.description, form.title, router, updateMutation]);
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-muted-foreground mt-2 text-xs">
                        Internal label. Used for your library + GeeLark task plan name (not the TikTok caption).
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      />
                      <p className="text-muted-foreground mt-2 text-xs">
                        This becomes GeeLark <span className="font-medium">videoDesc</span> for the “Post video” task.
                      </p>
                    </div>
                    ...
                    <div className="flex gap-3">
                      ...
                      <Button
                        ...
                        disabled={!canEdit || updateMutation.isPending || submitMutation.isPending}
                      >

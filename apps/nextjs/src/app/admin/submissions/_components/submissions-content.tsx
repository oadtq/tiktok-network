...
type StatusFilter = "all" | "submitted" | "approved" | "publishing" | "published" | "failed";
...
export function SubmissionsContent({ user }: SubmissionsContentProps) {
  ...
  const { data: submissions, isLoading, refetch } = useQuery(
    trpc.admin.submissions.queryOptions(
  ...
  const approveMutation = useMutation(
    trpc.admin.approveClip.mutationOptions({
      onSuccess: () => {
        void queryClient.invalidateQueries({ queryKey: trpc.admin.submissions.queryKey() });
          ...
          <div className="flex h-16 items-center justify-between px-8">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Review and manage all clip submissions
              </p>
            </div>
            <div className="flex items-center gap-3">
              <Button
        ...
        <div className="p-8">
          ...
          <div className="mb-6 flex gap-2 overflow-x-auto">
            {(Object.keys(statusLabels) as StatusFilter[]).map((status) => (
              ...
              >
                {statusLabels[status]}
                {status === "submitted" && pendingClips && pendingClips.length > 0 && (
            ...
            <div className="flex flex-col items-center justify-center rounded-xl border border-border bg-card py-16">
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                {statusFilter === "all"
                  ...
                  : `No submissions with status "${statusLabels[statusFilter]}"`}
              </p>
            </div>
          ) : (
              ...
              {submissions?.map((clip) => (
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    {/* Actions - Only show approve for submitted */}
